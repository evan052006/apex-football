...
from main.views import show_index, show_products_by_xml, show_products_by_json, show_product_xml_by_id, show_product_json_by_id, create_product, show_product, login_user, register_user, logout_user
